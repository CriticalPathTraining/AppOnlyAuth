...
namespace DailyReporterPro.Models {
  ...
  public class PbiEmbeddedManager {
    ...
    static string applicationId = ConfigurationManager.AppSettings["applicationId"];
    static string applicationSecret = ConfigurationManager.AppSettings["applicationSecret"];
    ...
    public static async Task<HomeViewModel> GetHomeView() {
      ...
      var workspace = workspaces.Where(ws => ws.Id == appWorkspaceId).First();
